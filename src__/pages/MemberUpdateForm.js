    ...
    return (
        <>
            ...
            <InputGroup className="mb-3">
                <Form.Control input onChange={handleChange} type="text" name="name" value={state.name}/>
                <Form.Control input onChange={handleChange} type="text" name="addr" value={state.addr}/>
                <Button variant="info" onClick={handleSave}>수정확인</Button>
            </InputGroup>
