...
function GalleryForm() {
    ...
    const handleChange = (e) => {
        //이벤트가 일어난 요소(input type="file") 에 선택된 파일 목록 참조 
    ...
    const handleUpload = () => {
        ...
        formData.append("caption", inputCaption.current.value)
    ...
    return (
        <>
            <Form.Group className="mb-3" controlId="caption">
                ...
                <Form.Control ref={inputCaption} type="text" name="caption" placeholder="설명 입력..." />
            </Form.Group>
            ...
            <a href="about:blank" onClick={(e)=>{
                e.preventDefault() //빈 페이지를 띄우려고하는 기본 동작 막기
